                            ...
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#m_modal_6"><i class="fa fa-plus pr-2 pt-1"></i>اضافة صلاحيات</button>
                                    </h3>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">إنشاء الصلاحيات</h5>
...
{{--    <script src="{{ asset('assets/js/toastr.js') }}" type="text/javascript"></script>--}}
                    ...
                    },
                {
                    ...
                    template: function (row) {
                        ...
                        <div class="d-inline-flex">
                            <a href="/panel/cms/admin/permissions/`+row.id+`/edit" class="btn btn-primary m-btn--custom d-flex align-items-center justify-content-center fs-10 p-0 w-65 h-30 mr-3">
    ...
    <script>
        function save(){
            axios.post('/panel/admin/permissions', {
        ...
        function destroy(id){
            axios.delete('/panel/admin/permissions/'+id)
                .then(function (response) {
