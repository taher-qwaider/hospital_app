                        ...
                        <div class="m-portlet m-portlet--tab">
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row mb-25">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control m-input" type="text" value="{{ $section->name }}" id="name">
                                    </div>
                                </div>
{{--                                <div class="form-group m-form__group row mb-25">--}}
                        ...
                        <div class="m-portlet m-portlet--tab mb-25">
                            <div class="m-portlet__body">
                                <div class="m-portlet__head-title col-sm-12">
                                    <button type="button" class="btn btn-success col-sm-12" onclick="save({{ $section->id }})">حفظ</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        function save(id){
            ...
            axios.post('{!! route('sections.update', $section->id) !!}', formData)
