...
@section('title', 'تعديل قسام')

@section('styles')
    <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js"></script>
@endsection

@section('sub-title', 'تعديل قسام ')
                        ...
                        <div class="m-portlet m-portlet--tab">
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row mb-25">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control m-input" type="text" value="{{ $event->title }}" id="title">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row mb-25">
                                    <label for="body" class="col-3 col-form-label">الوصف</label>
                                    <div class="col-9">
                                        <input class="form-control m-input" type="text" value="{{ $event->body }}" id="body">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row mb-25">
                        ...
                        <div class="m-portlet m-portlet--tab mb-25">
                            <div class="m-portlet__body">
                                <div class="m-portlet__head-title col-sm-12">
                                    <button type="button" class="btn btn-success col-sm-12" onclick="save({{ $event->id }})">حفظ</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        function save(id){
            ...
            axios.post('{!! route('events.update', $event->id) !!}', formData)
