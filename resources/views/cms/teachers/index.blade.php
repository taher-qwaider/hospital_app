...
@section('scripts')
            ...
            $(function () {
                var table = $('.my_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'teach_level', name: 'teach_level'},
                        {data: 'admin.first_name', name: 'admin.first_name'},
    ...
    <script>
        ...
        function destroy(id){
            axios.delete('/panel/admin/teachers/'+id)
